...
namespace Automation_Framework.Tests.Pages
{
    public class HomePage : BasePage
    {
        ...
        public IButton ComedyHorizontalScrollBars => new WebElement(Driver, "//div[@id='Comedy Movies']//div[@class='css-nlgfro']", Selector.Xpath);
        ...
        public void ScrollComedyBar() => ComedyHorizontalScrollBars.GetElementAndScrollTo();
