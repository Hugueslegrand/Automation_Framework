...
namespace Automation_Framework.Tests.Screens
{
    public class RegisterScreen : BasePage
    {
        ...
        public void AndroidClearRegisterFields()
        {
            AndroidRegisterFirstName.AndroidClear();
            Swipe(685, 1400, 685, 800, 500);
            AndroidRegisterLastName.AndroidClear();
            //SwipeModal(0, 10);
            AndroidRegisterEmail.AndroidClear();
            AndroidRegisterPassword.AndroidClear();
            //Swipe(5, 10, 5, -5, 2000);
            AndroidRegisterRePassword.AndroidClear();
