...
namespace Automation_Framework.Tests.Pages
{
    public class MyMoviesPage : BasePage
    {
        ...
        public IParagraph MovieTitle => new WebElement(Driver, "//p[@class='css-49l3oe']", Selector.Xpath);
        public IParagraph MovieAvailableDate => new WebElement(Driver, "//p[@class='css-1l8ljr1']", Selector.Xpath);
        public IButton MovieHoverPoster => new WebElement(Driver, "//img[@class='testing css-8cfhcr']", Selector.Xpath);
        public IParagraph MovieHoverTitle => new WebElement(Driver, "//p[@class='css-49l3oe']", Selector.Xpath);
        public IParagraph MovieHoverDescription => new WebElement(Driver, "//p[@class='css-1sivm4u']", Selector.Xpath);
        ...
        public ILabel RentWarning => new WebElement(Driver, "//body/div[@id='root']/div[@class='App']/div/div/div[@class='css-1sxv7u5']/div[@class='css-f97be3']/div[3]/p[1]//*[name()='svg']", Selector.Xpath);
